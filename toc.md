...
## [1 前言](ch01.md#1-preface)
  + [1.1 小型嵌入式系统中的多任务处理](ch01.md#11-multitasking-in-small-embedded-systems)
    ...
    + [1.1.3 术语说明](ch01.md#113-a-note-about-terminology)
  ...
  + [1.2 包含的源文件和项目](ch01.md#12-included-source-files-and-projects)
    + [1.2.1 获取随本书附带的示例](ch01.md#121-obtaining-the-examples-that-accompany-this-book)

## [2 FreeRTOS内核发行版](ch02.md#2-the-freertos-kernel-distribution)
  + [2.1 引言](ch02.md#21-introduction)
  + [2.2 理解FreeRTOS发行版](ch02.md#22-understanding-the-freertos-distribution)
    ...
    + [2.2.6 特定于端口的FreeRTOS源文件](ch02.md#226-freertos-source-files-specific-to-a-port)
  ...
  + [2.5 数据类型和编码风格指南](ch02.md#25-data-types-and-coding-style-guide)
    ...
    + [2.5.2 变量名称](ch02.md#252-variable-names)
    + [2.5.3 函数名称](ch02.md#253-function-names)
...
## [3 堆内存管理](ch03.md#3-heap-memory-management)
  ...
  + [3.3 与堆相关的实用函数和宏](ch03.md#33-heap-related-utility-functions-and-macros)
    ...
    + [3.3.5 收集每任务堆使用统计信息](ch03.md#335-collecting-per-task-heap-usage-statistics)
...
## [4 任务管理](ch04.md#4-task-management)
  ...
  + [4.5 任务优先级](ch04.md#45-task-priorities)
    + [通用调度程序](ch04.md#451-generic-scheduler)
    + [架构优化调度程序](ch04.md#452-architecture-optimized-scheduler)
  + [4.6 时间测量和滴答中断](ch04.md#46-time-measurement-and-the-tick-interrupt)
  + [4.7 扩展 *Not Running* 状态](ch04.md#47-expanding-the-not-running-state)
    + [4.7.1 *Blocked* 状态](ch04.md#471-the-blocked-state)
    + [4.7.2 *Suspended* 状态](ch04.md#472-the-suspended-state)
  ...
  + [4.11 线程本地存储和重入](ch04.md#411-thread-local-storage-and-reentrancy)
  ...
  + [4.12 调度算法](ch04.md#412-scheduling-algorithms)
    ...
    + [4.12.5 合作式调度](ch04.md#4125-cooperative-scheduling)
...
## [5 队列管理](ch05.md#5-queue-management)
  ...
  + [5.2 队列的特性](ch05.md#52-characteristics-of-a-queue)
    ...
    + [5.2.5 多个队列阻塞](ch05.md#525-blocking-on-multiple-queues)
  ...
  + [5.6 从多个队列接收](ch05.md#56-receiving-from-multiple-queues)
    ...
    + [5.6.5 更现实的队列集使用场景](ch05.md#565-more-realistic-queue-set-use-cases)
...
## [6 软件定时器管理](ch06.md#6-software-timer-management)
  + [6.1 章节介绍与范围](ch06.md#61-chapter-introduction-and-scope)
...
## [7 中断管理](ch07.md#7-interrupt-management)
  ...
  + [7.4 用于同步的二进制信号量](ch07.md#74-binary-semaphores-used-for-synchronization)
    ...
    + [7.4.4 改进示例7.1中使用的任务的实现](ch07.md#744-improving-the-implementation-of-the-task-used-in-example-71)
  ...
  + [7.6 将工作延迟到RTOS守护任务](ch07.md#76-deferring-work-to-the-rtos-daemon-task)
  ...
  + [7.7 在中断服务例程中使用队列](ch07.md#77-using-queues-within-an-interrupt-service-routine)
    ...
    + [7.7.2 从ISR中使用队列时的考虑因素](ch07.md#772-considerations-when-using-a-queue-from-an-isr)
  + [7.8 中断嵌套](ch07.md#78-interrupt-nesting)
    + [7.8.1 给ARM Cortex-M[^22]和ARM GIC用户的注意事项](ch07.md#781-a-note-to-arm-cortex-m22-and-arm-gic-users)
...
## [8 资源管理](ch08.md#8-resource-management)
  ...
  + [8.2 临界区和挂起调度程序](ch08.md#82-critical-sections-and-suspending-the-scheduler)
...
## [9 事件组](ch09.md#9-event-groups)
  ...
  + [9.2 事件组的特性](ch09.md#92-characteristics-of-an-event-group)
    ...
    + [9.2.2 关于EventBits_t数据类型的更多信息](ch09.md#922-more-about-the-eventbits_t-data-type)
...
## [10 任务通知](ch10.md#10-task-notifications)
  ...
  + [10.2 任务通知；优点和局限性](ch10.md#102-task-notifications-benefits-and-limitations)
    + [10.2.1 任务通知的性能优点](ch10.md#1021-performance-benefits-of-task-notifications)
    + [10.2.2 任务通知的RAM占用优点](ch10.md#1022-ram-footprint-benefits-of-task-notifications)
  ...
  + [10.3 使用任务通知](ch10.md#103-using-task-notifications)
    ...
    + [10.3.7 任务通知用于外围设备驱动程序：UART示例](ch10.md#1037-task-notifications-used-in-peripheral-device-drivers-uart-example)
    + [10.3.8 任务通知用于外围设备驱动程序：ADC示例](ch10.md#1038-task-notifications-used-in-peripheral-device-drivers-adc-example)
    + [10.3.9 任务通知直接用于应用程序](ch10.md#1039-task-notifications-used-directly-within-an-application)

## [11 低功耗支持](ch11.md#11-low-power-support)
  + [11.1 功耗节省介绍](ch11.md#111-power-saving-introduction)
  + [11.2 FreeRTOS 休眠模式](ch11.md#112-freertos-sleep-modes)
  + [11.3 函数和启用内置无时钟空闲功能](ch11.md#113-functions-and-enabling-built-in-tickless-idle-functionality)
...
## [12 开发者支持](ch12.md#12-developer-support)
  ...
  + [12.4 调试相关的钩子（回调）函数](ch12.md#124-debug-related-hook-callback-functions)
    + [12.4.1 内存分配失败的钩子](ch12.md#1241-malloc-failed-hook)
  + [12.5 查看运行时和任务状态信息](ch12.md#125-viewing-run-time-and-task-state-information)
    ...
    + [12.5.7 生成和显示运行时统计信息，一个实例](ch12.md#1257-generating-and-displaying-run-time-statistics-a-worked-example)
...
## [13 疑难解答](ch13.md#13-troubleshooting)
  ...
  + [13.5 其他常见错误来源](ch13.md#135-other-common-sources-of-error)
    + [13.5.1 症状：向演示中添加一个简单任务会导致演示崩溃](ch13.md#1351-symptom-adding-a-simple-task-to-a-demo-causes-the-demo-to-crash)
    ...
    + [13.5.5 症状：中断意外地被禁用，或关键部分没有正确嵌套](ch13.md#1355-symptom-interrupts-are-unexpectedly-left-disabled-or-critical-sections-do-not-nest-correctly)
    + [13.5.6 症状：应用程序在调度器启动之前崩溃](ch13.md#1356-symptom-the-application-crashes-even-before-the-scheduler-is-started)
    + [13.5.7 症状：在调度器暂停时调用 API 函数，或在关键部分内部调用，会导致应用程序崩溃](ch13.md#1357-symptom-calling-api-functions-while-the-scheduler-is-suspended-or-from-inside-a-critical-section-causes-the-application-to-crash)
  + [13.6 附加调试步骤](ch13.md#136-additional-debugging-steps)
...
+ [示例 5.2 向队列发送时阻塞，并通过队列发送结构](ch05.md#example5.2)
+ [示例 5.3 使用队列集](ch05.md#example5.3)
+ [示例 6.1 创建一次性和自动重载定时器](ch06.md#example6.1)
...
+ [示例 7.3 集中化延迟中断处理](ch07.md#example7.3)
+ [示例 7.4 在中断中通过队列发送和接收](ch07.md#example7.4)
...
+ [图 2.3 FreeRTOS 目录树中的特定端口源文件](ch02.md#fig2.3)
+ [图 2.4 演示目录层次结构](ch02.md#fig2.4)
+ [图 3.1 每次创建任务时从 heap_1 数组分配的 RAM](ch03.md#fig3.1)
+ [图 3.2 创建和删除任务时从 heap_2 数组分配和释放的 RAM](ch03.md#fig3.2)
+ [图 3.3 从 heap_4 数组分配和释放的 RAM](ch03.md#fig3.3)
+ [图 3.4 内存映射](ch03.md#fig3.4)
+ [图 4.1 顶级任务状态和转换](ch04.md#fig4.1)
+ [图 4.2 执行示例 4.1 时生成的输出](ch04.md#fig4.2)
+ [图 4.3 两个示例 4.1 任务的实际执行模式](ch04.md#fig4.3)
+ [图 4.4 扩展的执行序列显示时钟中断执行](ch04.md#fig4.4)
+ [图 4.5 以不同优先级运行两个任务](ch04.md#fig4.5)
+ [图 4.6 一个任务的优先级高于另一个任务的执行模式](ch04.md#fig4.6)
+ [图 4.7 完整任务状态机](ch04.md#fig4.7)
+ [图 4.8 执行示例 4.4 时生成的输出](ch04.md#fig4.8)
+ [图 4.9 任务使用 vTaskDelay() 替代空循环时的执行序列](ch04.md#fig4.9)
+ [图 4.10 粗体线表示任务执行的状态转换](ch04.md#fig4.10)
+ [图 4.11 执行示例 4.6 时生成的输出](ch04.md#fig4.11)
+ [图 4.12 示例 4.6 的执行模式](ch04.md#fig4.12)
+ [图 4.13 执行示例 4.7 时生成的输出](ch04.md#fig4.13)
+ [图 4.14 运行示例 4.8 时的任务执行序列](ch04.md#fig4.14)
+ [图 4.15 执行示例 4.8 时生成的输出](ch04.md#fig4.15)
+ [图 4.16 执行示例 4.9 时生成的输出](ch04.md#fig4.16)
+ [图 4.17 示例 4.9 的执行序列](ch04.md#fig4.17)
+ [图 4.18 突出显示任务优先级和抢占的执行模式](ch04.md#fig4.18)
+ [图 4.19 突出显示任务优先级和时间片轮转的执行模式](ch04.md#fig4.19)
+ [图 4.20 与图 4.19 所示相同场景的执行模式](ch04.md#fig4.20)
+ [图 4.21 示例执行模式，展示了相同优先级的任务如何](ch04.md#fig4.21)
+ [图 4.22 示例执行模式，展示了合作调度器的行为](ch04.md#fig4.22)
+ [图 5.1 队列的写入和读取示例序列](ch05.md#fig5.1)
+ [图 5.2 执行示例 5.1 时生成的输出](ch05.md#fig5.2)
+ [图 5.3 示例 5.1 生成的执行序列](ch05.md#fig5.3)
+ [图 5.4 结构在队列上发送的示例场景](ch05.md#fig5.4)
+ [图 5.5 示例 5.2 生成的输出](ch05.md#fig5.5)
+ [图 5.6 示例 5.2 生成的执行序列](ch05.md#fig5.6)
+ [图 5.7 执行示例 5.3 时生成的输出](ch05.md#fig5.7)
+ [图 6.1 一次性和自动重载软件定时器行为的差异](ch06.md#fig6.1)
+ [图 6.2 自动重载软件定时器状态和转换](ch06.md#fig6.2)
+ [图 6.3 一次性软件定时器状态和转换](ch06.md#fig6.3)
+ [图 6.4 软件定时器 API 函数使用的定时器命令队列，以与 RTOS 守护任务通信](ch06.md#fig6.4)
+ [图 6.5 调用 xTimerStart() 的任务优先级高于守护任务优先级时的执行模式](ch06.md#fig6.5)
+ [图 6.6 调用 xTimerStart() 的任务优先级低于守护任务优先级时的执行模式](ch06.md#fig6.6)
+ [图 6.7 执行示例 6.1 时生成的输出](ch06.md#fig6.7)
+ [图 6.8 执行示例 6.2 时生成的输出](ch06.md#fig6.8)
+ [图 6.9 启动和重置周期为 6 个时钟周期的软件定时器](ch06.md#fig6.9)
+ [图 6.10 执行示例 6.3 时生成的输出](ch06.md#fig6.10)
+ [图 7.1 在高优先级任务中完成中断处理](ch07.md#fig7.1)
+ [图 7.2 使用二进制信号量实现延迟中断处理](ch07.md#fig7.2)
+ [图 7.3 使用二进制信号量同步任务与中断](ch07.md#fig7.3)
+ [图 7.4 执行示例 7.1 时生成的输出](ch07.md#fig7.4)
+ [图 7.5 执行示例 7.1 时的执行序列](ch07.md#fig7.5)
+ [图 7.6 任务在处理第一个事件之前发生一个中断的情况](ch07.md#fig7.6)
+ [图 7.7 任务在处理第一个事件之前发生两个中断的情况](ch07.md#fig7.7)
+ [图 7.8 使用计数信号量](ch07.md#fig7.8)
+ [图 7.9 执行示例 7.2 时生成的输出](ch07.md#fig7.9)
+ [图 7.10 执行示例 7.3 时生成的输出](ch07.md#fig7.10)
+ [图 7.11 执行示例 7.3 时的执行序列](ch07.md#fig7.11)
+ [图 7.12 执行示例 7.4 时生成的输出](ch07.md#fig7.12)
+ [图 7.13 示例 7.4 生成的执行序列](ch07.md#fig7.13)
+ [图 7.14 影响中断嵌套行为的常量](ch07.md#fig7.14)
+ [图 7.15 Cortex-M 微控制器实现四个优先级位时存储二进制优先级 101 的方式](ch07.md#fig7.15)
+ [图 8.1 使用互斥锁实现互斥](ch08.md#fig8.1)
+ [图 8.2 执行示例 8.1 时生成的输出](ch08.md#fig8.2)
+ [图 8.3 示例 8.1 的可能执行序列](ch08.md#fig8.3)
+ [图 8.4 最坏情况的优先级反转场景](ch08.md#fig8.4)
+ [图 8.5 优先级继承最小化优先级反转的影响](ch08.md#fig8.5)
+ [图 8.6 当具有相同优先级的任务使用相同的互斥锁时的可能执行序列](ch08.md#fig8.6)
+ [图 8.7 如果创建了两个具有相同优先级的任务实例，则可能发生的执行序列](ch08.md#fig8.7)
+ [图 8.8 执行示例 8.2 时生成的输出](ch08.md#fig8.8)
+ [图 9.1 事件标志到位号的映射，位于类型为 EventBits_t 的变量中](ch09.md#fig9.1)
+ [图 9.2 仅设置了位 1、4 和 7，所有其他事件标志都清除，使事件组](ch09.md#fig9.2)
+ [图 9.3 当将 xWaitForAllBits 设置为 pdFALSE 时执行示例 9.1 时生成的输出](ch09.md#fig9.3)
+ [图 9.4 当将 xWaitForAllBits 设置为 pdTRUE 时执行示例 9.1 时生成的输出](ch09.md#fig9.4)
+ [图 9.5 执行示例 9.2 时生成的输出](ch09.md#fig9.5)
+ [图 10.1 通信对象用于从一个任务向另一个任务发送事件](ch10.md#fig10.1)
+ [图 10.2 任务通知用于直接从一个任务向另一个任务发送事件](ch10.md#fig10.2)
+ [图 10.3 执行示例 7.1 时生成的输出](ch10.md#fig10.3)
+ [图 10.4 执行示例 10.1 时的执行序列](ch10.md#fig10.4)
+ [图 10.5 执行示例 10.2 时生成的输出](ch10.md#fig10.5)
+ [图 10.6 应用程序任务到云服务器及返回的通信路径](ch10.md#fig10.6)
+ [图 12.1 FreeRTOS+Trace 包含 20 多个相互连接的视图](ch12.md#fig12.1)
+ [图 12.2 FreeRTOS+Trace 主跟踪视图 - 20 多个相互连接的跟踪视图之一](ch12.md#fig12.2)
+ [图 12.3 FreeRTOS+Trace CPU 负载视图 - 20 多个相互连接的跟踪视图之一](ch12.md#fig12.3)
+ [图 12.4 FreeRTOS+Trace 响应时间视图 - 20 多个相互连接的跟踪视图之一](ch12.md#fig12.4)
+ [图 12.5 FreeRTOS+Trace 用户事件图视图 - 20 多个相互连接的跟踪视图之一](ch12.md#fig12.5)
+ [图 12.6 FreeRTOS+Trace 内核对象历史记录视图 - 20 多个相互连接的跟踪视图之一](ch12.md#fig12.6)
...
+ [列表 2.1 新的 main() 函数模板](ch02.md#list2.1)
+ [列表 3.1 vPortDefineHeapRegions() API 函数原型](ch03.md#list3.1)
+ [列表 3.2 HeapRegion_t 结构](ch03.md#list3.2)
+ [列表 3.3 一个 HeapRegion_t 结构数组，描述 RAM 的 3 个区域](ch03.md#list3.3)
+ [列表 3.4 一个 HeapRegion_t 结构数组，描述所有的 RAM2、所有的 RAM3，但只描述 RAM1 的一部分](ch03.md#list3.4)
+ [列表 3.5 使用 GCC 语法声明将被 heap_4 使用的数组，并将数组放置在名为 .my_heap 的内存段中](ch03.md#list3.5)
+ [列表 3.6 使用 IAR 语法声明将被 heap_4 使用的数组，并将数组放置在绝对地址 0x20000000](ch03.md#list3.6)
+ [列表 3.7 xPortGetFreeHeapSize() API 函数原型](ch03.md#list3.7)
+ [列表 3.8 xPortGetMinimumEverFreeHeapSize() API 函数原型](ch03.md#list3.8)
+ [列表 3.9 vPortGetHeapStatus() API 函数原型](ch03.md#list3.9)
+ [列表 3.10 HeapStatus_t() 结构](ch03.md#list3.10)
+ [列表 3.11 收集每任务的堆使用统计信息](ch03.md#list3.11)
+ [列表 3.12 malloc 失败的钩子函数名称和原型](ch03.md#list3.12)
+ [列表 3.13 将 pvPortMallocStack() 和 vPortFreeStack() 宏映射到应用程序定义的内存分配器](ch03.md#list3.13)
+ [列表 3.14 vApplicationGetTimerTaskMemory 的典型实现](ch03.md#list3.14)
+ [列表 3.15 vApplicationGetIdleTaskMemory 的典型实现](ch03.md#list3.15)
+ [列表 4.1 任务函数原型](ch04.md#list4.1)
+ [列表 4.2 典型任务函数的结构](ch04.md#list4.2)
+ [列表 4.3 xTaskCreate() API 函数原型](ch04.md#list4.3)
+ [列表 4.4 示例 4.1 中使用的第一个任务的实现](ch04.md#list4.4)
+ [列表 4.5 示例 4.1 中使用的第二个任务的实现](ch04.md#list4.5)
+ [列表 4.6 启动示例 4.1 任务](ch04.md#list4.6)
+ [列表 4.7 调度器启动后在另一个任务中创建任务](ch04.md#list4.7)
+ [列表 4.8 示例 4.2 中用于创建两个任务的单个任务函数](ch04.md#list4.8)
+ [列表 4.9 示例 2 的 main() 函数](ch04.md#list4.9)
+ [列表 4.10 使用 pdMS_TO_TICKS() 宏将 200 毫秒转换为...](ch04.md#list4.10)
+ [列表 4.11 创建两个不同优先级的任务](ch04.md#list4.11)
+ [列表 4.12 vTaskDelay() API 函数原型](ch04.md#list4.12)
+ [列表 4.13 示例任务的源代码，将空循环延迟替换为调用...](ch04.md#list4.13)
+ [列表 4.14 vTaskDelayUntil() API 函数原型](ch04.md#list4.14)
+ [列表 4.15 使用 vTaskDelayUntil() 实现示例任务](ch04.md#list4.15)
+ [列表 4.16 示例 4.6 中使用的连续处理任务](ch04.md#list4.16)
...
+ [清单 4.25 示例 4.8 的 main() 的实现](ch04.md#list4.25)
+ [清单 4.26 vTaskDelete() API 函数原型](ch04.md#list4.26)
+ [清单 4.27 示例 4.9 的 main() 的实现](ch04.md#list4.27)
+ [清单 4.28 示例 4.9 的任务 1 的实现](ch04.md#list4.28)
+ [清单 4.29 示例 4.9 的任务 2 的实现](ch04.md#list4.29)
...
+ [清单 5.9 要通过队列传递的结构的定义，以及示例使用的两个变量的声明](ch05.md#list5.9)
+ [清单 5.10 示例 5.2 的发送任务的实现](ch05.md#list5.10)
+ [清单 5.11 示例 5.2 的接收任务的定义](ch05.md#list5.11)
+ [清单 5.12 示例 5.2 的 main() 的实现](ch05.md#list5.12)
+ [清单 5.13 创建一个保存指针的队列](ch05.md#list5.13)
+ [清单 5.14 使用队列发送指向缓冲区的指针](ch05.md#list5.14)
+ [清单 5.15 使用队列接收指向缓冲区的指针](ch05.md#list5.15)
+ [清单 5.16 在 FreeRTOS+TCP 中用于将事件发送到 TCP/IP 栈任务的结构](ch05.md#list5.16)
...
+ [清单 5.19 伪代码，展示如何使用 IPStackEvent_t 结构将网络关闭事件发送到 TCP/IP 任务](ch05.md#list5.19)
+ [清单 5.20 伪代码，展示如何接收和处理 IPStackEvent_t 结构](ch05.md#list5.20)
...
+ [清单 5.27 包含队列和信号量的队列集](ch05.md#list5.27)
+ [清单 5.28 作为邮箱使用的队列创建](ch05.md#list5.28)
...
+ [清单 6.5 示例 6.1 中使用的定时器创建和启动](ch06.md#list6.5)
+ [清单 6.6 示例 6.1 中一次性定时器使用的回调函数](ch06.md#list6.5)
...
+ [清单 6.10 示例 6.2 中使用的定时器创建](ch06.md#list6.10)
...
+ [清单 6.15 示例 6.3 中一次性定时器使用的回调函数](ch06.md#list6.15)
...
+ [清单 7.6 实现定期生成软件中断的任务，如示例 7.1](ch07.md#list7.6)
+ [清单 7.7 实现将中断处理推迟到的任务（任务...](ch07.md#list7.7.)
+ [清单 7.8 示例 7.1 中使用的软件中断的 ISR](ch07.md#list7.8)
+ [清单 7.9 示例 7.1 的 main() 的实现](ch07.md#list7.9)
+ [清单 7.10 建议的推迟中断处理任务的结构，使用 UART 接收...](ch07.md#list7.10)
+ [清单 7.11 xSemaphoreCreateCounting() API 函数原型](ch07.md#list7.11)
+ [清单 7.12 用于在示例 7.2 中创建计数信号量的 xSemaphoreCreateCounting() 调用](ch07.md#list7.12)
+ [清单 7.13 示例 7.2 使用的中断服务例程的实现](ch07.md#list7.13)
...
+ [清单 7.17 执行示例 7.3 中中断所需的处理的函数](ch07.md#list7.17)
+ [清单 7.18 示例 7.3 的 main() 的实现](ch07.md#list7.18)
...
+ [清单 8.6 中断服务例程中使用临界区](ch08.md#list8.6)
...
+ [清单 8.12 示例 8.1 的 prvPrintTask() 的实现](ch08.md#list8.12)
+ [清单 8.13 示例 8.1 的 main() 的实现](ch08.md#list8.13)
+ [清单 8.14 创建和使用递归互斥锁](ch08.md#list8.14)
+ [清单 8.15 在紧密循环中使用互斥锁的任务](ch08.md#list8.15)
+ [清单 8.16 确保在循环中使用互斥锁的任务获得更均等的处理时间...](ch08.md#list8.16)
+ [清单 8.17 计时器钩子函数的名称和原型](ch08.md#list8.17)
+ [清单 8.18 门卫任务](ch08.md#list8.18)
+ [清单 8.19 示例 8.2 的打印任务实现](ch08.md#list8.19)
+ [清单 8.20 计时器钩子的实现](ch08.md#list8.20)
+ [清单 8.21 示例 8.2 的 main() 的实现](ch08.md#list8.21)
...
+ [清单 9.8 示例 9.1 中设置事件组中位 2 的 ISR](ch09.md#list9.8)
+ [清单 9.9 示例 9.1 中阻塞以等待事件位被设置的任务](ch09.md#list9.9)
+ [清单 9.10 示例 9.1 中创建事件组和任务](ch09.md#list9.10)
+ [清单 9.11 两个任务的伪代码，它们相互同步以确保共享的 TCP 套接字...](ch09.md#list9.11)
+ [清单 9.12 xEventGroupSync() API 函数原型](ch09.md#list9.12)
+ [清单 9.13 示例 9.2 中使用的任务实现](ch09.md#list9.13)
...
+ [清单 10.4 将中断处理推迟到的任务的实现（即任务...](ch10.md#list10.4)
+ [清单 10.5 示例 10.1 中使用的中断服务例程的实现](ch10.md#list10.5)
+ [清单 10.6 将中断处理推迟到的任务的实现（即任务...](ch10.md#list10.6)
...
+ [清单 10.10 伪代码，演示如何在驱动程序库传输...](ch10.md#list10.10)
+ [清单 10.11 伪代码演示如何在驱动程序库中使用任务通知进行传输...](ch10.md#list10.11)
+ [清单 10.12 伪代码演示如何在驱动程序库中使用任务通知进行接收...](ch10.md#list10.12)
+ [清单 10.13 伪代码演示如何使用任务通知将值传递给任务](ch10.md#list10.13)
+ [清单 10.14 发送到服务器任务队列的结构和数据类型](ch10.md#list10.14)
...
+ [清单 11.6 用户定义的portSUPPRESS\_TICKS\_AND\_SLEEP()实现示例](ch11.md#list11.6)
+ [清单 11.7 vApplicationIdleHook API函数原型](ch11.md#list11.7)
+ [清单 12.1 使用标准C assert()宏检查pxMyPointer不是NULL](ch12.md#list12.1)
+ [清单 12.2 在调试器控制下执行时有用的简单configASSERT()定义](ch12.md#list12.2)
+ [清单 12.3 记录失败断言的源代码行的configASSERT()定义](ch12.md#list12.3)
...
+ [清单 12.10 用于计算定时器溢出的16位定时器溢出中断处理程序](ch12.md#list12.10)
+ [清单 12.11 添加到FreeRTOSConfig.h中的宏以启用运行时统计信息的收集](ch12.md#list12.11)
...
## 表格：
+ [表1 要包含在项目中的FreeRTOS源文件](ch02.md#tbl1)
+ [表2 TickType_t数据类型和configTICK_TYPE_WIDTH_IN_BITS配置](ch02.md#tbl2)
+ [表3 宏前缀](ch02.md#tbl3)
+ [表4 常见宏定义](ch02.md#tbl4)
+ [表5 FreeRTOSConfig.h设置以配置内核调度算法](ch04.md#tbl5)
+ [表6 uxBitsToWaitFor和xWaitForAllBits参数的效果](ch09.md#tbl6)
